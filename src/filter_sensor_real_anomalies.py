...
def load_and_segment(processed_dir, max_segments=None):
    """
    data/processed içindeki .npy dosyalarını (Ni,20480,Ci) alır,
    200’lük kaydırmalı segmentlere böler ve
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--score_csv", default="sensor_real_scores.csv",
    ...
    parser.add_argument(
        ...
        help="Segment sayısını evaluate_real_data.py ile eşitlemek için maksimum pencere sayısı"
    )
